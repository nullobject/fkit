...
describe('list.fold', () => {
  ...
  describe('#maximumBy', () => {
    it('handles an array of numbers', () => {
      assert.equal(fold.maximumBy(compare)([1, 2, 3]), 3)
    })

    it('handles a string', () => {
      assert.equal(fold.maximumBy(compare)('foo'), 'o')
    })
  })

  describe('#minimumBy', () => {
    it('handles an array of numbers', () => {
      assert.equal(fold.minimumBy(compare)([1, 2, 3]), 1)
    })

    it('handles a string', () => {
      assert.equal(fold.minimumBy(compare)('foo'), 'f')
    })
  })
